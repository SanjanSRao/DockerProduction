# -*- coding: utf-8 -*-
"""
Created on Fri Sep  6 20:49:17 2019
...
def cluster():
    ...
    data['clean_sum'] = data[unstructure].apply(cleanse)
    ...
    data_pivot.to_excel(writer, sheet_name = 'Report', 
                  encoding = 'utf-8', index=False)
    ...
    chart.add_series({
            'values': '=Report!$B$2:$B'+str(no_of_clusters+1)
            })
